...
export const COMPANY_LIST_RENTERS_REQUEST = 'COMPANY_LIST_RENTERS_REQUEST'
export const COMPANY_LIST_RENTERS_SUCCESS = 'COMPANY_LIST_RENTERS_SUCCESS'
export const COMPANY_LIST_RENTERS_FAIL = 'COMPANY_LIST_RENTERS_FAIL'