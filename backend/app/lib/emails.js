...
export const InquiryEmailTemplate = (user) => `Hi <strong> There! </strong> <br> From Live Networking Email Service ${user.fromEmail} want to ask this from you, please have a look on his query, <br> <strong> ${user.text} </strong>,<br> you can find his email from CC <br> Thanks <br> Live Email Networking Service`;
